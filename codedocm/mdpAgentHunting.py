...
#         if ghost:
#             for x, y in ghost:
#                 self.map[int(x)][int(y)] = 'G' # original
#
#                 # self.map[int(x)][int(y + 1)] = 'G' # North
#                 # # self.map[int(x)][int(y + 2)] = 'G' # North + North
#                 # self.map[int(x + 1)][int(y)] = 'G' # East
#                 # # self.map[int(x + 2)][int(y)] = 'G' # East + East
#                 # self.map[int(x + 1)][int(y + 1)] = 'G' # Northeast
#                 # # self.map[int(x + 2)][int(y + 2)] = 'G'
#                 # self.map[int(x)][int(y - 1)] = 'G' # South
#                 # self.map[int(x)][int(y - 2)] = 'G' # South + South
#                 # self.map[int(x + 1)][int(y - 1)] = 'G' # Southeast
#                 # self.map[int(x - 1)][int(y - 1)] = 'G' # Southwest
#                 # self.map[int(x - 1)][int(y)] = 'G' # West
#                 # self.map[int(x - 1)][int(y + 1)] = 'G' # Northwest
#
#     # # Utility array v1
#     # def Utility(self):
...
#         if self.row > 8:
#             status = {0: [], 1: []}
#             for gh, st in api.ghostStates(state):
#                 status[st].append(gh)
#             if not status[1]:
#                 for x, y in ghosts:
...
#             for s in f:
#                 if not status[1]:
#                     if (s in foods) or (s in set(ghosts)) or (s in cap):
#                         continue
#                 else:
#                     if s in set(ghosts):
#                         continue
